			...
			<table class="borderbox" style="border: solid #d9d9d9 1.0pt; width: 100%; border-collapse: collapse;">
				<tbody>
					<tr>
						...
						<p class="running_text" style="font-family: Calibri,sans-serif; letter-spacing: .3pt; font-size: 10.0pt; color: #595959;">Il team Hoststar</p>
						</td>
					</tr>
				</tbody>
			</table>
		...
		<tr>
			...
			<table class="borderbox" style="border: solid #d9d9d9 1.0pt; width: 100%; border-collapse: collapse;">
				<tbody>
					<tr>
						<td class="borderbox" style="padding: 22.7pt; border-collapse: separate;">
						<p class="running_text" style="font-family: Calibri,sans-serif; letter-spacing: .3pt; font-size: 10.0pt; color: #595959;">[SWITCH_RECHNUNGSSTATUS_INFO][SWITCH_ABO_LOESCHINSTRUKTIONEN]Se per il futuro rinnovo dei contratti dovesse cambiare l&#39;indirizzo al quale rivolgerci, allora la preghiamo di modificare i dati del cliente nel suo account My Hoststar - <a href="https://my.hoststar.ch">https://my.hoststar.ch</a>.</p>
						</td>
					</tr>
				</tbody>
			</table>
