SELECT 1                                    AS bill_type,
       ...
       kunde.firma                          AS client_company_name,
       kunde.vorname                        AS client_first_name,
       kunde.name                           AS client_second_name,
       kunde.email                          AS client_email,
       kunde.telefon_mobil                  AS client_phone,
       kunde.plz                            AS client_postcode,
       NULL                                 AS client_country,
       kunde.ortschaft                      AS client_city,
       kunde.strasse                        AS client_street,
