    ...
    public function up()
    {
        return App::$db->exec("
            ...
            (
                ...
                `company_name`            varchar(35)                      DEFAULT NULL COMMENT 'client\'s company name',
                `first_name`              varchar(35)             NOT NULL COMMENT 'client\'s name',
                `second_name`             varchar(35)             NOT NULL COMMENT 'client\'s surname',
                `email`                   varchar(255)            NOT NULL COMMENT 'client\'s email',
                `phone`                   varchar(20)                      DEFAULT NULL COMMENT 'client\'s phone',
                `postcode`                varchar(10)             NOT NULL COMMENT 'client\'s zip-code',
                `country`                 varchar(40)                      DEFAULT NULL COMMENT 'client\'s country',
                `city`                    varchar(40)             NOT NULL COMMENT 'client\'s city',
                `street`                  varchar(40)             NOT NULL COMMENT 'client\'s street',
